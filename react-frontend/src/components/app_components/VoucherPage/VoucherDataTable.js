...
const pCategoryIdNameTemplate0_0 = (rowData, { rowIndex }) => <p >{rowData.category_id?.name}</p>
const inputTitleTemplate1 = (rowData, { rowIndex }) => <p >{rowData.title}</p>
const inputPointsTemplate3 = (rowData, { rowIndex }) => <p >{rowData.points}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="category_id.name" header="Name" body={pCategoryIdNameTemplate0_0} style={{ minWidth: "8rem" }} />
<Column field="title" header="Title" body={inputTitleTemplate1} filter={selectedFilterFields.includes("title")} hidden={selectedHideFields?.includes("title")}  sortable  style={{ minWidth: "8rem" }} />
<Column field="points" header="Points Required" body={inputPointsTemplate3} filter={selectedFilterFields.includes("points")} hidden={selectedHideFields?.includes("points")}  sortable  style={{ minWidth: "8rem" }} />
