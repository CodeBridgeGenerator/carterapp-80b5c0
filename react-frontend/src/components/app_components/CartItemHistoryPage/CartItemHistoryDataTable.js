...
const pUserEmailTemplate0_0 = (rowData, { rowIndex }) => <p >{rowData.user?.email}</p>
const pVoucherTitleTemplate1_0 = (rowData, { rowIndex }) => <p >{rowData.voucher?.title}</p>
const inputQuantityTemplate2 = (rowData, { rowIndex }) => <p >{rowData.quantity}</p>
const datetimeTimestampTemplate3 = (rowData, { rowIndex }) => <p >{rowData.timestamp}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="user.email" header="Email" body={pUserEmailTemplate0_0} style={{ minWidth: "8rem" }} />
<Column field="voucher.title" header="Title" body={pVoucherTitleTemplate1_0} style={{ minWidth: "8rem" }} />
<Column field="quantity" header="Quantity" body={inputQuantityTemplate2} filter={selectedFilterFields.includes("quantity")} hidden={selectedHideFields?.includes("quantity")}  sortable  style={{ minWidth: "8rem" }} />
<Column field="timestamp" header="Order Timestamp" body={datetimeTimestampTemplate3} filter={selectedFilterFields.includes("timestamp")} hidden={selectedHideFields?.includes("timestamp")}  sortable  style={{ minWidth: "8rem" }} />
